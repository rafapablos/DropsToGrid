# NOTE: This file is a copy paste from https://github.com/Lightning-AI/pytorch-lightning/pull/20545
# Can be removed once the PR is merged and the code is available in the Lightning library.
...
class WeightAveraging(Callback):
    ...
    def on_load_checkpoint(
        ...
        """
        if self._average_model is None:
            # Not "fit" stage, so nothing to do.
            return
